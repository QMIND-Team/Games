        ...
        for oriCurrent in range(game.currentPiece.numOrientations()):
            for posCurrent in range(Game.gridWidth - game.currentPiece.width(oriCurrent) + 1):
                for oriNext in range(game.nextPiece.numOrientations()):
                    for posNext in range(Game.gridWidth - game.nextPiece.width(oriNext) + 1):
                        ...
                        allOptions.append(Option.Option(myGame.grid, oriCurrent, posCurrent, oriNext, posNext, myGame.numLinesCleared, rowAddedAt))
        return allOptions
